...
class ExaminationsTable extends Component {
  ...
  handleMoreExaminations = () => {
    ...
    if (isMobile) this.props.getExaminationsMobile(start, end);
    else this.props.getExaminations(start, end);
  };
    ...
    return (
      <List>
        ...
        {totalExaminations !== data.length && (
          <div style={{ display: "flex", justifyContent: "center" }}>
            <IconButton
              onClick={() => this.handleMoreExaminationsMobile()}
