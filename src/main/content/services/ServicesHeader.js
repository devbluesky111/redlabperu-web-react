        ...
        return (
            <div className={classNames(classes.root, "flex flex-1 w-full items-center justify-between")}>
                ...
                <FuseAnimate animation="transition.expandIn" delay={300}>
                    ...
                    <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                        <Typography className="" variant="h6">Servicios</Typography>
                    </FuseAnimate>
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        setSearchText: Actions.setServicesSearchText,
    }, dispatch);
}

function mapStateToProps({servicesReducer})
{
    return {
...
export default withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(ServicesHeader));
