...
function MainNavbar({classes, navigation, layoutStyle, user})
{
    function UserHeader()
    {
        return (
            ...
            >
                <Typography className="username text-16 whitespace-no-wrap" color="inherit">{user.data.person.displayName}</Typography>
                <Typography className="email text-13 mt-8 opacity-50 whitespace-no-wrap" color="inherit">{user.data.user.email}</Typography>
                <Avatar
